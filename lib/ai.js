...
async function executeToolCall(toolCall) {
  ...
  switch (functionName) {
    ...
    case 'listMyRedmineTasks':
      return await callMCPTool('list_my_tasks', {});

    case 'getRedmineIssueDetails':
      return await callMCPTool('get_issue_details', {
        issue_id: args.issue_id
      });

    case 'logRedmineTime':
      return await callMCPTool('log_time', {
        issue_id: args.issue_id,
        hours: args.hours,
    ...
    case 'updateRedmineIssueStatus':
      return await callMCPTool('update_issue_status', {
        issue_id: args.issue_id,
        status: args.status
      });
    ...
    case 'addRedmineNote':
      return await callMCPTool('add_note', {
        issue_id: args.issue_id,
        note: args.note
      });

    case 'getTodayRedmineLogs':
      return await callMCPTool('get_today_logs', {});

    case 'getRedmineLogsRange':
      return await callMCPTool('get_time_logs_range', {
