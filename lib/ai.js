 ...
 * @param {string} userId - Slack user ID (optional, for permission checks)
 * @returns {Promise<string>} AI response text
 */
export async function callAI(threadMessages, apiKey, model, projectId = null, userId = null) {
  try {
    // Log thread messages
    ...
    if (isCodeReview) {
      ...
      systemPrompt = getSystemPrompt(vnTime, threadMessages);
