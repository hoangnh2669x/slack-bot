...
const TOOL_NAME_MAP = {
  'list_my_tasks': 'redmine_list_my_tasks',
  'get_issue_details': 'redmine_get_issue_details',
  'log_time': 'redmine_log_time',
  'update_issue_status': 'redmine_update_issue_status',
  'update_progress': 'redmine_update_progress',
  'add_note': 'redmine_add_note',
  'get_today_logs': 'redmine_get_today_logs',
  'get_time_logs_range': 'redmine_get_time_logs_range'
};

/**
 * Call MCP tool (backward compatible)
 * @param {string} toolName - Original or prefixed tool name
 * @param {Object} args - Tool arguments
 * @returns {Promise<Object>} Tool result
 */
export async function callMCPTool(toolName, args = {}) {
  const toolKey = TOOL_NAME_MAP[toolName] || toolName;
  return await callDynamicMCPTool(toolKey, args);
}
